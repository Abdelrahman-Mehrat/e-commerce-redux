...
<Alert show={show} key={"info"} variant={"info"} className="addCard_alert" >
    ...
    </Alert>
      {
        ...
        >
          <div onClick={()=>{ navigate(`./product/${singleProduct.id}`)}}  className="Link_noStyle card product-card h-100">
          <button className="card_fav-icon"  onClick={(e) => { favIconFunc(e) }}><BsEmojiSmile/></button>
